...
class QueryDecoder(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.dn = True
        self.query_dim = 4
        self.num_queries = self.video_max_len
        ...
        self.label_enc = nn.Embedding(self.num_classes + 1, self.hidden_dim - 1)
        #####################################################################
    ...
    def forward(self, memory_cache, vis_pos=None, text_cls=None, targets = None):
        ...
        if self.dn and targets != None:
            ...
            embedweight = embedweight[:t]

            input_query_label, input_query_bbox, attn_mask, mask_dict = \
                prepare_for_dn(dn_args, embedweight, 1, training, self.num_queries, self.num_classes,
        ...
        fsdfdsafgdfgf
        ## need to add attn_mask and decoder part
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        if self.from_scratch_cross_attn: # this one runs 
