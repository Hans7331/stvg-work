...
class CrossModalEncoder(nn.Module):
    ...
    def forward(self, videos : NestedTensor = None, vis_pos = None, texts : Tuple = None):
        ...
        vis_features_init = vis_features.clone()
        ...
        img_memory, frames_cls, videos_cls = self.encoder(
            ...
            vis_features_init = vis_features_init
        )
...
class SpatialTemporalEncoder(nn.Module):
    ...
    def forward(
        ...
        for i_layer, layer in enumerate(self.spatial_layers):
            ...
            # print("output before vivit",output.shape) torch.Size([310, 64, 256])
            output = layer(
                output,
                src_mask=mask,
            ...
            # print("frames_src after vivit", frames_src.shape) torch.Size([1, 65, 256])
            frames_src_list = []
            for i_dur, dur in enumerate(durations):
