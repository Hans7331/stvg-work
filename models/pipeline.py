...
class STCATNet(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.ground_encoder = build_encoder(cfg, vivit = False)
    ...
    def forward(self, videos, texts, targets = None, logger=None):
        """
        Arguments:
