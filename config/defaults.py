...
_C.DATA_DIR = '../stcat_data/data/vidstg/'
_C.GLOVE_DIR = '../stcat_data/data/glove/'
_C.TENSORBOARD_DIR = '../stcat_data/data/tensorboard/'
...
_C.MODEL.WEIGHT = "/data/hc-stvg/checkpoints/stcat_res448/model_final.pth"
_C.MODEL.EMA = True
...
_C.SOLVER.BASE_LR = 0.1 #2e-5
_C.SOLVER.VIS_BACKBONE_LR = 0.1 #1e-5
...
_C.SOLVER.SCHEDULE.TYPE =  "multistep_with_warmup"  #"linear_with_warmup"
