...
def train(cfg, local_rank, distributed, logger):
    ...
    for iteration, batch_dict in enumerate(train_data_loader, start_iter):
        ...
        if iteration % 50 == 0 or iteration == max_iter:
            ...
            #checkpointer.save("model_replace", **arguments)
...
def run_test(cfg, model, model_ema, logger, distributed):
    ...
    print("val_data_loader", val_data_loader)
    do_eval(
        cfg,
        mode='test',
        logger=logger,
...
if __name__ == "__main__":
    ...
    #os.environ['LD_LIBRARY_PATH'] += ":" + "/scratch/project_462000189/hans/ffmpeg/lib"
    #os.environ['PATH'] += ":" + "/scratch/project_462000189/hans/ffmpeg/bin"
    #os.environ['LD_LIBRARY_PATH'] += ":" + "/scratch/project_462000189/hans/ffmpeg/lib"
